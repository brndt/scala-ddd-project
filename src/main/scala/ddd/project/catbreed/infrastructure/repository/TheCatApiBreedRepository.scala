...
final class TheCatApiBreedRepository(implicit executionContext: ExecutionContext, system: ClassicActorSystemProvider) extends CatBreedRepository[Future] with CatBreedMarshaller {
